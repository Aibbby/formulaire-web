...
class AppSimulateurBase1(tk.Tk):
    ...
    def _build_server_tab(self) -> None:
        ...
        connection.pack(side="left", fill="x", expand=True, padx=(0, 10))
        ...
        pan_frame.pack(side="right", anchor="ne")
        ...
        self.send_message_button.grid(row=0, column=2, padx=(0, 22), sticky="w")
        ...
        tk.Entry(
            ...
            width=32,
            font=("Consolas", 10),
        ).grid(row=2, column=1, padx=(5, 18), pady=(10, 0), sticky="w")
        ...
        tk.Entry(
            ...
            width=25,
            font=("Consolas", 10),
        ).grid(row=2, column=4, padx=(5, 18), pady=(10, 0), sticky="w")
